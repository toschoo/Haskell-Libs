...
\usepackage{hyperref}
\hypersetup{
   pdfauthor={Ludwig Wittgenstein},   pdftitle={Tractatus Logico-Philosophicus},   pdfsubject={Philosophy,Logic},   pdfcreator={Kevin C. Klement},
...
\end{tikzpicture}
\end{center}}
\newcommand{\theline}{\begin{center}   \begin{tikzpicture}
   ...
   \end{tikzpicture}\end{center}}
\newcommand{\fourthreeonetablegerman}{\begin{tabular}{c|c|c}
$p$ & $q$ & $r$ \\ \hhline{=|=|=}
W & W & W \\ \hline%\hhline{-|-|-~-|-~-}
F & W & W \\ \hline%\hhline{-|-|-~-|-~-}
W & F & W \\ \hline%\hhline{-|-|-~-|-~~}
...
F \\ \hline
\end{tabular}}
\newcommand{\fourthreeonetableenglish}{\begin{tabular}{c|c|c}
$p$ & $q$ & $r$ \\ \hhline{=|=|=}
T & T & T \\ \hline%\hhline{-|-|-~-|-~-}
F & T & T \\ \hline%\hhline{-|-|-~-|-~-}
T & F & T \\ \hline%\hhline{-|-|-~-|-~~}
...
F \\ \hline
\end{tabular}}
\newcommand{\fourfourfourtwotablegerman}{{\hfil \begin{tabular}{r c|c|c l}
&$p$ & $q$ & & \gdqr \\ \hhline{~=|=|=~}
& W  &  W  &  W &\\ \hhline{~---~}
& F  &  W  &  W &\\ \hhline{~---~}
& W  &  F  &  & \\ \hhline{~---~}
\gdql & F  &  F  &  W \\ \hhline{~---~}
\end{tabular} \hfil}}
\newcommand{\fourfourfourtwotableogden}{{\hfil\begin{tabular}{r c|c|c l}
`` &$p$ & $q$ & & \\ \hhline{~=|=|=~}
& T  &  T  &  T &\\ \hhline{~---~}
& F  &  T  &  T &\\ \hhline{~---~}
& T  &  F  &  & \\ \hhline{~---~}
...
\newcommand{\fourfourfourtwotablepmc}{\pbk\pbk{\hfil\begin{tabular}{r c|c|c l}
` &$p$ & $q$ & & ' \\ \hhline{~=|=|=~}
& T  &  T  &  T &\\ \hhline{~---~}
& F  &  T  &  T &\\ \hhline{~---~}
& T  &  F  &  & \\ \hhline{~---~}
...
\newcommand{\fiveonezeroonetablegerman}{\begin{scriptsize}\begin{longtable}{@{}l@{} @{}c@{} @{}c@{} @{}r@{} @{\thinspace}l@{~} @{~}l@{} @{~}l@{}}\vspace*{0pt}(W&W&W&W) & $(p,q)$ &Tautologie                  &(Wenn $p$, so $p$; und wenn $q$, so $q$.) \\
...
\newcommand{\fiveonezeroonetableogden}{\begin{scriptsize}\begin{longtable}{@{}l@{} @{}c@{} @{}c@{} @{}r@{} @{\thinspace}l@{~} @{~}l@{} @{~}l@{}}\vspace*{0pt}(T&T&T&T) & $(p,q)$ &Tautology                  &(if $p$ then $p$; and if $q$ then $q$) \\
\vspace*{0pt}  & & &   &         &                             &\qquad $[p \rimplies p \rand q \rimplies q]$\\
...
\end{longtable}\end{scriptsize}}
\newcommand{\fiveonezeroonetablepmc}{\begin{scriptsize}\begin{longtable}{@{}l@{} @{}c@{} @{}c@{} @{}r@{} @{\thinspace}l@{~} @{~}l@{} @{~}l@{}}\vspace*{0pt}(T&T&T&T) & $(p,q)$ &Tautology                  &(If $p$ then $p$; and if $q$ then $q$.) \\
\vspace*{0pt}  & & &   &         &                             &\qquad $(p \rimplies p \rand q \rimplies q)$\\
\vspace*{0pt}(F&T&T&T) & $(p,q)$ &In words:                   &Not both $p$ and $q$. \quad$(\rnot (p \rand q))$\\
...
\clearpage\phantomsection\addcontentsline{toc}{chapter}{Introduction (by Bertrand Russell)}\begin{multicols}{2}[\section*{Introduction}By Bertrand Russell, F.\ R.\ S.]
...
% PREFACE
%=============================================
\begin{parcolumns}[sloppy,                    rulebetween,
                    colwidths={1={0.05in},2={3.15in},3={3.15in},4={3.15in}}                    ]{4}
\pnskip
\ger{\negpbk\textbf{German}\\~}
\ogd{\negpbk\textbf{Ogden}\\~}
...
\begin{parcolumns}[sloppy,% 
                    rulebetween,
                    colwidths={1={.8in},2={2.9in},3={2.9in},4={2.9in}}                    ]{4}
\pnskip
\ger{\negpbk\textbf{German}\\~}
\ogd{\negpbk\textbf{Ogden}\\~}
\pmc{\negpbk\textbf{Pears/McGuinness}\\~}
...
\pnskip\ger{Wenn die Dinge in Sachverhalten vorkommen k{\"o}nnen, so muss dies schon in ihnen liegen.}
...
\pnskip
\ger{Dies erkl{\"a}rt wohl auch, dass man die Figur\vspace*{-8pt}\thecube}
\ogd{This perhaps explains that the figure \phantom{longwordhere}\vspace*{-8pt}\thecube}
\pmc{This no doubt also explains why there are two possible ways of seeing the figure\vspace*{-8pt}\thecube}
