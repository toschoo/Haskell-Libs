...
\hypersetup{colorlinks=true, linkcolor=black, pdfauthor=Bertrand Russell, pdftitle=Introduction to Mathematical Philosophy, pdfcreator=Kevin C. Klement, pdfsubject=Philosophy}
\usepackage[paper=a5paper,vmargin=1.5cm,lmargin=1cm,rmargin=1.5cm]{geometry}
%
...
\newcommand{\aftonly}[1]{#1}      % Two sided A4 version only; used
...
\setlength{\titlepagemiddle}{165pt}
%
